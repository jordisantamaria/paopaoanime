    ...
    return (
      <div className="mx-auto max-w-md py-16 text-center">
        <div className="rounded-lg bg-bg-card border border-border p-8">
          ...
          <p className="text-sm text-text-secondary mb-6">{t("invalidLinkDesc")}</p>
    ...
    return (
      <div className="mx-auto max-w-md py-16 text-center">
        <div className="rounded-lg bg-bg-card border border-border p-8">
          ...
          <h1 className="text-xl font-bold mb-2">{t("passwordChanged")}</h1>
          <p className="text-sm text-text-secondary mb-6">{t("passwordChangedDesc")}</p>
          <Link
            href="/login"
